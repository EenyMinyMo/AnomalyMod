...
public class ElectraDischargeSphericalParticle extends AbstractParticleSimpleData {

    private final float maxSize;


    public ElectraDischargeSphericalParticle(float x, float y, float z, int maxLifeTime) {
        super(x, y, z, maxLifeTime, ParticleIcons.lightEnerg7Icon);

        Random randomizer = SomberCommonUtil.RANDOMIZER;

        this.maxSize = randomizer.nextFloat() * 1.7F + 1.2F;
