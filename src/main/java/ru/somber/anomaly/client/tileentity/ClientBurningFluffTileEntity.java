...
public class ClientBurningFluffTileEntity extends AbstractClientTileEntity {
    ...
    public ClientBurningFluffTileEntity() {
        super();

        BurningFluffEmitter emitter = new BurningFluffEmitter(0, 0, 0);
        setEmitter(emitter);
